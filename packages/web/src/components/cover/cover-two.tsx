      ...
      <div className="h-[900px] w-[600px] text-center font-bold text-[#331F14]">
        <div className="cover-svg-overlay-one relative h-full w-full">
          ...
          <div className="absolute left-0 top-0 w-full">
            <div className="cover-simple-border cover-simple-border-inset mx-auto mt-32 w-[400px] bg-[#F5E1C9] px-4 pb-8 pt-4">
              <h1 className="balance-text mb-4 mt-4 font-serif text-5xl italic leading-snug">
                {name}
              </h1>
