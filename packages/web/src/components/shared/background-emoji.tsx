...
export const BackgroundEmoji = ({
  ...
  return (
    <div
      className={cn(className, "w-auto", tiled ? "bg-repeat" : "bg-cover")}
      style={{
        backgroundImage: `linear-gradient(0deg, var(--nn-fade) 20%, transparent), url("data:image/svg+xml;base64,${btoa(
