...
const buttonVariants = cva(
  "inline-flex items-center justify-center rounded-md text-xs font-bold leading-tight",
  {
    variants: {
      variant: {
        default: "bg-nn-base",
        ...
        destructive:
          "bg-red-500 text-nn-base-light dark:bg-red-900 dark:text-nn-base-light",
